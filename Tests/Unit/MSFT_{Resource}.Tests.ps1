...
$Global:DSCResourceName = 'MSFT_{Resource}'
...
try
{
    InModuleScope $Global:DSCResourceName {
        ...
        Describe 'MSFT_{Resource}\Get-TargetResource' -Tag 'Get' {
            BeforeAll {
        ...
        Describe 'MSFT_{Resource}\Set-TargetResource' -Tag 'Set' {
            BeforeAll {
        ...
        Describe 'MSFT_{Resource}\Test-TargetResource' -Tag 'Test' {
            BeforeAll {
